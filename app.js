function initMap() {
  ...
  map2.setOptions({ minZoom: 3, maxZoom: 15 });
  ...
  map3.setOptions({ minZoom: 2, maxZoom: 15 });
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary fav" data-title="Zion National Park">Add to Favorites</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
  ...
  var parks = {
    ...
    'Haleakal&#257; National Park': contentHaleakala,
